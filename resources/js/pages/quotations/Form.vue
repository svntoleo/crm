...
const form = useForm({
  ...
  stage_id: props.quotation?.stage_id ?? null,
});
...
<template>
  <Head :title="props.quotation ? 'Edit Quotation' : 'Create Quotation'" />
  <AppLayout>
    <div class="p-6 max-w-4xl">
      <h1 class="text-3xl font-bold mb-6">{{ props.quotation ? 'Edit Quotation' : 'Create Quotation' }}</h1>
        ...
        <CardContent>
          <div class="space-y-4">
            <div>
              ...
              <Input id="title" v-model="form.title" placeholder="e.g. Website Redesign" />
            </div>
