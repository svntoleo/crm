...
class QuotationController extends Controller
{
    public function index(Request $request)
    {
        ...
        $quotations = $query->paginate(50)->withQueryString()->through(fn($item) => array_merge($item->toArray(), ['urls' => ['show' => route('quotations.show', $item), 'edit' => route('quotations.edit', $item), 'destroy' => route('quotations.destroy', $item)]]));
